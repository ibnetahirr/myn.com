			...
			<Layout >
				...
				<section className="section-blog-3 position-relative border section-padding fix">
						...
						<div className="row align-items-end mb-5">
							<div className="col-md-auto col-12 me-auto">
								<div className="d-flex align-items-center justify-content-center bg-primary-soft border border-2 border-white d-inline-flex rounded-pill px-4 py-2" data-aos="zoom-in" data-aos-delay={100}>
									<img src="/assets/imgs/features-1/dots.png" alt="my-yoga-network" />
									<span className="tag-spacing fs-7 fw-bold text-linear-2 ms-2 text-uppercase">From Blog</span>
								</div>
								<h3 className="ds-3 mt-3 mb-3">Our Latest Insights</h3>
								<span className="fs-5 fw-medium">Explore tips and trends for holistic wellness and yoga practices</span>
							</div>
						...
						<div className="row">
							<div className="col-lg-6 pe-lg-8">
								<Link href="#" className="d-flex flex-md-row flex-column align-items-center mb-4 hover-up">
									<img className="rounded-3 w-100 w-md-auto" src="/assets/imgs/blog-3/img-1.png" alt="my-yoga-network" />
									<span className="content ms-5 mt-md-0 mt-3">
										<h6 className="mb-2">10 Yoga Poses to Enhance Corporate Wellness in 2025</h6>
										<p>Discover how tailored yoga practices are transforming workplace health and productivity for corporates...</p>
									</span>
								</Link>
								<Link href="#" className="d-flex flex-md-row flex-column align-items-center mb-4 hover-up">
									<img className="rounded-3 w-100 w-md-auto" src="/assets/imgs/blog-3/img-2.png" alt="my-yoga-network" />
									<span className="content ms-5 mt-md-0 mt-3">
										<h6 className="mb-2">The Role of Mindfulness in Hotel Guest Experiences</h6>
										<p>Learn how yoga and mindfulness are elevating guest satisfaction in the hospitality industry...</p>
									</span>
								</Link>
							</div>
							<div className="col-lg-6 pe-lg-8">
								<Link href="#" className="d-flex flex-md-row flex-column align-items-center mb-4 hover-up">
									<img className="rounded-3 w-100 w-md-auto" src="/assets/imgs/blog-3/img-3.png" alt="my-yoga-network" />
									<span className="content ms-5 mt-md-0 mt-3">
										<h6 className="mb-2">Why Yoga Retreats Boost Hotel Revenue</h6>
										<p>Explore the impact of wellness programs on hotel profitability and guest loyalty...</p>
									</span>
								</Link>
								<Link href="#" className="d-flex flex-md-row flex-column align-items-center mb-4 hover-up">
									<img className="rounded-3 w-100 w-md-auto" src="/assets/imgs/blog-3/img-4.png" alt="my-yoga-network" />
									<span className="content ms-5 mt-md-0 mt-3">
										<h6 className="mb-2">Top Wellness Trends Impacting Corporate Health in 2025</h6>
										<p>Stay ahead with the latest yoga and wellness trends shaping corporate well-being...</p>
									</span>
								</Link>
							</div>
						</div>
					...
					<div className="position-absolute top-0 start-50 translate-middle-x z-0">
						<img src="/assets/imgs/blog-2/img-bg-line.png" alt="my-yoga-network" />
					</div>
						...
						<div className="col-10 mx-auto">
							<div className="banner bg-primary-light rounded-3 position-relative px-8 py-lg-0 py-8">
								<div className="d-flex flex-column flex-lg-row align-items-center justify-content-between position-relative z-1">
									...
									<img src="/assets/imgs/banner-2/img-1.png" alt="my-yoga-network" />
								...
								<img className="position-absolute top-0 end-0 z-0" src="/assets/imgs/services-details/bg-line-1.png" alt="my-yoga-network" />
								<img className="position-absolute bottom-0 start-0 z-0" src="/assets/imgs/services-details/bg-line-2.png" alt="my-yoga-network" />
								<img className="flickering position-absolute top-0 end-50 me-5 mt-3 z-0" src="/assets/imgs/banner-2/star-1.png" alt="my-yoga-network" />
								<img className="flickering position-absolute bottom-0 start-50 ms-md-10 mb-3 ps-10 z-0" src="/assets/imgs/banner-2/star-2.png" alt="my-yoga-network" />
							</div>
						</div>
					</div>
				</div>
						...
						<div className="row">
							<div className="col-lg-10 mx-lg-auto mt-8">
								...
								<div className="border-top py-5 position-relative d-flex flex-column flex-md-row align-items-center" data-aos="fade-zoom-in" data-aos-delay={100}>
									<img className="rounded-3 w-100 w-md-auto" src="/assets/imgs/blog-7/img-1.png" alt="my-yoga-network" />
									<div className="ms-5 w-lg-50 me-auto">
										<Link href="#" className="bg-primary-soft position-relative z-1 d-inline-flex rounded-pill px-3 py-2 mt-3">
											<span className="tag-spacing fs-7 fw-bold text-linear-2 text-uppercase">Wellness</span>
										</Link>
										<h6 className="my-3">The Role of Mindfulness in Hotel Guest Experiences</h6>
										<p>Learn how yoga and mindfulness are elevating guest satisfaction in the hospitality industry...</p>
									</div>
								...
								<div className="border-top py-5 position-relative d-flex flex-column flex-md-row align-items-center" data-aos="fade-zoom-in" data-aos-delay={100}>
									<img className="rounded-3 w-100 w-md-auto" src="/assets/imgs/blog-7/img-2.png" alt="my-yoga-network" />
									<div className="ms-5 w-lg-50 me-auto">
										<Link href="#" className="bg-primary-soft position-relative z-1 d-inline-flex rounded-pill px-3 py-2 mt-3">
											<span className="tag-spacing fs-7 fw-bold text-linear-2 text-uppercase">Yoga</span>
										</Link>
										<h6 className="my-3">The Future of Corporate Wellness Programs</h6>
										<p>Discover how yoga is shaping the future of employee health and productivity...</p>
									</div>
									<Link href="#" className="rounded-pill bg-white border d-lg-inline-block px-4 py-2 d-none">
										<svg xmlns="http://www.w3.org/2000/svg" width={18} height={11} viewBox="0 0 18 11" fill="none">
											<path className="fill-dark" d="M13.0633 0.563232L12.2615 1.36505L15.8294 4.93297H0V6.06692H15.8294L12.2615 9.6348L13.0633 10.4366L18 5.49991L13.0633 0.563232Z" fill="#111827" />
								...
								<div className="border-top py-5 position-relative d-flex flex-column flex-md-row align-items-center" data-aos="fade-zoom-in" data-aos-delay={100}>
									<img className="rounded-3 w-100 w-md-auto" src="/assets/imgs/blog-7/img-3.png" alt="my-yoga-network" />
									<div className="ms-5 w-lg-50 me-auto">
										<Link href="#" className="bg-primary-soft position-relative z-1 d-inline-flex rounded-pill px-3 py-2 mt-3">
											<span className="tag-spacing fs-7 fw-bold text-linear-2 text-uppercase">Health</span>
										</Link>
										<h6 className="my-3">The Importance of Yoga in Healthcare Settings</h6>
										<p>Understand how yoga enhances patient recovery and staff well-being in healthcare...</p>
									</div>
									<Link href="#" className="rounded-pill bg-white border d-lg-inline-block px-4 py-2 d-none">
										<svg xmlns="http://www.w3.org/2000/svg" width={18} height={11} viewBox="0 0 18 11" fill="none">
											<path className="fill-dark" d="M13.0633 0.563232L12.2615 1.36505L15.8294 4.93297H0V6.06692H15.8294L12.2615 9.6348L13.0633 10.4366L18 5.49991L13.0633 0.563232Z" fill="#111827" />
								...
								<div className="border-top py-5 position-relative d-flex flex-column flex-md-row align-items-center" data-aos="fade-zoom-in" data-aos-delay={100}>
									<img className="rounded-3 w-100 w-md-auto" src="/assets/imgs/blog-7/img-4.png" alt="my-yoga-network" />
									<div className="ms-5 w-lg-50 me-auto">
										<Link href="#" className="bg-primary-soft position-relative z-1 d-inline-flex rounded-pill px-3 py-2 mt-3">
											<span className="tag-spacing fs-7 fw-bold text-linear-2 text-uppercase">Wellness</span>
										</Link>
										<h6 className="my-3">Choosing the Right Yoga Program for Your Organization</h6>
										<p>Learn how to select the best wellness solutions for hotels, corporates, and schools...</p>
									</div>
									<Link href="#" className="rounded-pill bg-white border d-lg-inline-block px-4 py-2 d-none">
										<svg xmlns="http://www.w3.org/2000/svg" width={18} height={11} viewBox="0 0 18 11" fill="none">
											<path className="fill-dark" d="M13.0633 0.563232L12.2615 1.36505L15.8294 4.93297H0V6.06692H15.8294L12.2615 9.6348L13.0633 10.4366L18 5.49991L13.0633 0.563232Z" fill="#111827" />
								...
								<div className="border-top py-5 position-relative d-flex flex-column flex-md-row align-items-center" data-aos="fade-zoom-in" data-aos-delay={100}>
									<img className="rounded-3 w-100 w-md-auto" src="/assets/imgs/blog-7/img-5.png" alt="my-yoga-network" />
									<div className="ms-5 w-lg-50 me-auto">
										<Link href="#" className="bg-primary-soft position-relative z-1 d-inline-flex rounded-pill px-3 py-2 mt-3">
											<span className="tag-spacing fs-7 fw-bold text-linear-2 text-uppercase">Health</span>
										</Link>
								...
								<div className="border-top py-5 position-relative d-flex flex-column flex-md-row align-items-center" data-aos="fade-zoom-in" data-aos-delay={100}>
									<img className="rounded-3 w-100 w-md-auto" src="/assets/imgs/blog-7/img-6.png" alt="my-yoga-network" />
									<div className="ms-5 w-lg-50 me-auto">
										<Link href="#" className="bg-primary-soft position-relative z-1 d-inline-flex rounded-pill px-3 py-2 mt-3">
											<span className="tag-spacing fs-7 fw-bold text-linear-2 text-uppercase">Yoga</span>
										</Link>
							...
							<div className="col-lg-6 mx-auto">
								<div className="px-lg-3 text-center">
									...
									<h4 className="my-5 text-white">
										We are trusted by over 25,000+ clients. <br />
										Join them now and elevate your wellness.
									</h4>
