                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6 mt-lg-0 mt-5">
                    ...
                    <div className="tab-content" id="nav-tabContent">
                      ...
                      >
                        <p className="text-900 mb-3">
                          Founded in 1998,{" "}
                          <span className="fw-black">Infinia</span> started as a
                          small consulting firm with a big vision: to provide
                          unparalleled strategic and operational expertise to
                          businesses of all sizes.
                        </p>
                        <div className="row">
                          <div className="col-12 col-md-6 mb-3 mb-md-0">
                            <p className="text-900">
                              Over the years, we have expanded our services and
                              grown our team of skilled professionals, building
                              a reputation for delivering results-driven
                              solutions. From our humble beginnings to becoming
                              a trusted partner for clients across diverse
                              industries
                            </p>
                      ...
                      >
                        <p className="text-900 mb-4">
                          Deliver Results-Driven Solutions: To provide
                          actionable and impactful strategies that drive
                          measurable success for our clients.
                        </p>
                        <div className="row">
                          <div className="col-12 col-md-6">
                            <p className="text-900">
                              Foster Innovation: To encourage creativity and
                              forward-thinking in all our projects, ensuring our
                              clients stay ahead of the curve.
                            </p>
                            <p>
                              Build Lasting Partnerships: To cultivate strong,
                              collaborative relationships with our clients,
                              based on trust, transparency, and mutual respect.
                            </p>
                            <p>
                              Enhance Operational Efficiency: To streamline
                              processes and optimize operations, helping
                              businesses achieve their goals more effectively.
                            </p>
                          </div>
                      ...
                      >
                        <p className="text-900 mb-4">
                          At Infinia, our vision is to empower businesses to
                          reach their full potential through innovative
                          strategies and expert operational support.{" "}
                        </p>
                        <div className="row">
                          <div className="col-12 col-md-6">
                            <p className="text-900">
                              We strive to be the leading consulting firm known
                              for our unwavering commitment to excellence,
                              integrity, and client success. By continuously
                              evolving and adapting to the ever-changing
                              business landscape, we aim to provide solutions
                              that not only meet the needs of today but also
                    ...
                    <div className="border-top pt-6 mt-md-8 mt-6">
                      ...
                      <p className="fs-7 text-500 mt-3">
                    ...
                    <div className="row align-items-center rounded-3 bg-white p-5">
                      ...
                      <div className="col-lg-7">
                        <div className="p-lg-3">
                          ...
                          <p>
                            We strive to build long-lasting partnerships with
                            our clients, understanding their unique challenges
                            and opportunities, and providing tailored strategies
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="card border-0 position-relative rounded-3 d-inline-flex card-hover">
                      ...
                      <div className="card-body bg-white p-6">
                        ...
                        <p>
                          As the SaaS industry continues to evolve, new trends
                          are shaping the future of software delivery and
                          consumption...
                        </p>
                        <Link
                          href="#"
