        ...
        <div className="container">
          <div className="text-center">
            ...
            <p className="fs-5 mb-0">
              ...
              platform, and services (collectively, "Services"). By accessing or
              using our Services, you agree to be{" "}
              <br className="d-none d-lg-block" />
          ...
          <div className="row pt-110">
            <div className="col-lg-8 col-md-10 mx-md-auto">
              ...
              <ul>
                ...
                <li>
                  Engage in any activity that could harm or damage our Services,
                  reputation, or users.
                </li>
              </ul>
              ...
              <p>
                ...
                software, are the property of My Yoga Network or our licensors
              ...
              <p>
                ...
                and commercial purposes in accordance with these Terms. You may
                not:
              </p>
              <ul>
                <li>
              ...
              <p>
                ...
                fully paid, sublicensable, and transferable license to use,
                reproduce, distribute, prepare derivative works of, display, and
                perform the content in connection with our Services and our
                business.
              </p>
              ...
              <p>
                ...
                have all necessary rights to submit the content and that it does
                not infringe or violate any third-party rights or any laws.
              </p>
              ...
              <p>
                ...
                our Services. We reserve the right to change our fees at any
              ...
              <p>
                ...
                breach these Terms. Upon termination, your right to use our
              ...
              <p>
                To the maximum extent permitted by law, My Yoga Network and its
              ...
              <p>
                ...
                Network and its affiliates, officers, directors, employees, and
              ...
              <p>
                ...
                of law principles. You agree to submit to the personal
              ...
              <p>
                ...
                taking effect. Your continued use of the Services after any such
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="bg-neutral-100 card-testimonial-3 p-5 rounded-3 position-relative">
                    ...
                    <p className="text-900 border-bottom pb-4 mb-4">
                      ...
                      have enhanced productivity and reduced stress effectively.
                    </p>
                    <div className="d-flex">
                      <img
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="bg-neutral-100 card-testimonial-3 p-5 rounded-3 position-relative">
                    ...
                    <p className="text-900 border-bottom pb-4 mb-4">
                      ...
                      have supported recovery and staff well-being effectively.
                    </p>
                    <div className="d-flex">
                      <img
                        src="/assets/imgs/hero-4/star-yellow.svg"
